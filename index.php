<?php require 'connect.php'; // VERSION 1.0 ?>
<!DOCTYPE html>
<html lang="pl">
<head>
	<meta charset="utf-8" />
		...
		<div class="container main-menu">
			<div class="row padding-vertical-2x">
				...
				<form method="post" action="lobby.php">
					...
					<div class="form_input"><input type="number" name="game_id" min="1000" max="9999" step="1" required /><label>ID gry</label></div>
					<input type="submit" class="button" name="connect" value="Połącz" />
				</form>
				</div>
				
				<div class="report_bug col-md-4">
				<a href="http://krylan.ovh/portfolio/contact/" target="_blank"><i class="material-icons">bug_report</i> Zgłoś błąd</a>
				</div>
			</div>
		</div>
	</div>
